...
namespace WPFBD_GD_1ER.Model
{
 ...
 public class C_TB_edition
 {
  ...
  public C_TB_edition()
  { }
  public C_TB_edition(string edi_nom_, string edi_dat_, string edi_pdg_nom_, string edi_pdg_prenom_)
  {
   edi_nom = edi_nom_;
   edi_dat = edi_dat_;
  ...
  public C_TB_edition(int ID_edition_, string edi_nom_, string edi_dat_, string edi_pdg_nom_, string edi_pdg_prenom_)
